...
namespace PokerTrainer.Desktop.Hosting;

internal static class ProductIdentity
{
    public static string ShortName { get; } = GetMetadata("ProductShortName", "PokerTrainer");

    public static string DisplayName { get; } = GetMetadata("ProductDisplayName", "PokerTrainer Desktop");
    ...
    public static string ApiExecutableName { get; } = GetMetadata("DesktopApiExecutableName", "PokerTrainer.Api");
